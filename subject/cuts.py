...
def open_cut(df, cuts_format='open/pre_close=100*(open/pre_close-1)', limit=None,bins=2,PRICEB=vars.CLOSE,PRICES=vars.CLOSE,days=1):
    res = pd.DataFrame()
...
save_data(ds,'%sopen切分回溯.csv'%start_date)